...
public class DoctorServiceImpl implements DoctorService 
{
	...
	public List<Doctor> searchDoctorsByIncomeRange(double start, double end)
	{
		...
		return drepo.searchDoctorsByIncomeRange(start, end);
	}
	...
	{	
		return drepo.showDoctorInfoByName(docName).orElseThrow(() -> new IllegalArgumentException("Doctor not found"));	
	}
	...
	{
		return drepo.showDoctorDataByName(docName);
	}
	...
	{	
		return drepo.showSpecializationByName(docName);
	}
	...
	{
		int count= drepo.fetchDoctorNameCount();
		return count;
	}
	...
	{
		Object obj=drepo.fetchAggregateData();
		return obj;
	}
