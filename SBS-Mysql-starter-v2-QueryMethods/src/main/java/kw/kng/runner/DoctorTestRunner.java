...
public class DoctorTestRunner implements CommandLineRunner {
	...
	public void run(String... args) throws Exception 
	{
		...
		*/
		...
		System.out.println("QUERY Methods Example: ");
		ds.searchDoctorsByIncomeRange(75000.0, 95000.0).forEach(System.out::println);
		
		
		System.out.println("----------------------------------------");
		System.out.println("Seatch Doctor details by Doctor Name: ");
		Doctor doc= ds.showDoctorInfoByName("Ajit");
		System.out.println("Doctor info:: " + doc);
		
		
		System.out.println("----------------------------------------");
		System.out.println("Seatch some Doctor details by Doctor Name: ");
		Object obj= ds.showDoctorDataByName("Ajit");
		...
		System.out.println("----------------------------------------");
		String result= ds.showSpecializationByName("Ajit");
		System.out.println("Specialization :: " + result);
		
		
		
		System.out.println("----------------------------------------");
		System.out.println("Unique doctor names count:: "+ds.showDoctorNamesCount());
		Object[] rslt=(Object[])ds.showAggregateData();
		System.out.println("Record Count:: "+rslt[0]);
		System.out.println("Max Income Value:: "+rslt[1]);
		System.out.println("Min Income Value:: "+rslt[2]);
		System.out.println("Avg of Income:: "+rslt[3]);
		System.out.println("Sum of Income:: "+rslt[4]);
